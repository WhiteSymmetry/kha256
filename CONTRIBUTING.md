...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/kha256/issues)
...
Look through the [GitHub Issues](https://github.com/WhiteSymmetry/kha256/issues) for any
...
Ready to contribute? Here's how to set up KHA256 for local development.
...
2. Create your own fork of the KHA256 [repository](https://github.com/WhiteSymmetry/kha256).
3. Clone your repository, for example by typing in your terminal:
`git clone https://github.com/<your_username>/kha256.git`.
4. Install `kha256` as editable in your new environment:
...
Please note that the KHA256 project is released with a
